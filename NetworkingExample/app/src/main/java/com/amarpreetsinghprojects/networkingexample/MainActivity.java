...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*try {
            ...
            RecyclerViewAdapter adapter = new RecyclerViewAdapter(userArrayList,this);
        ...
        new MyAsyscTask().execute("https://jsonplaceholder.typicode.com/posts");

    }
    public class MyAsyscTask extends AsyncTask<String,Void,ArrayList<User>>{
        ...
        protected void onPostExecute(ArrayList<User> users) {
            ...
            RecyclerViewAdapter adapter = new RecyclerViewAdapter(users,getBaseContext());
            rv.setAdapter(adapter);
        }
    }
}
